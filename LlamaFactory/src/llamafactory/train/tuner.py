...
def _training_function(config: dict[str, Any]) -> None:
    ...
    if is_env_enabled("PLATFORM_TRAIN_SMOKE"):
        training_args.report_to = []
        training_args.logging_dir = None
        from .platform_callback import PlatformResultCallback, PlatformTfeventsCallback

        callbacks.append(PlatformTfeventsCallback())
        callbacks.append(PlatformResultCallback())
        logger.info_rank0("Platform smoke training: HF tensorboard disabled; using platform tfevents writer.")
